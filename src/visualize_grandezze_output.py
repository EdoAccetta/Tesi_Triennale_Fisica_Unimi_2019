...
def output_all():
    ...
    with open(path_results + "grandezze_check.csv", "w") as file_results:
        ...
        for file in list_files_grandezze:
            with open(path_grandezze_basics + file, "r") as file_basics, open(path_grandezze_x + file, "r") as file_grandezze_x, open(path_grandezze_firstmax + file, "r") as file_firstmax, open(path_grandezze_trial + file, "r") as file_trial:
