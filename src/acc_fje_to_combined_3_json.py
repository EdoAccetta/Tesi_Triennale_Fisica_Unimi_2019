...
path_acc_data_json = path_acc_data + "/json_combinato_3/"
list_files = [
...
for file in list_files:
    ...
    with open(path_acc_data_fje + file, "r") as file_acc:
        ...
        for line in file_acc:
            ...
            linea["step"] = i
            gfx = float(valori[0]) + 9.947830
            gfy = float(valori[1]) + 0.026476
            gfz = float(valori[2]) + 0.238222
            linea["gFc"] = (gfx**2 + gfy**2 + gfz**2)**0.5
