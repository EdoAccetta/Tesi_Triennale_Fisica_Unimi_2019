...
path_acc_data_output = path_acc_data + "/json_passo_medio_combinato_grandezze/"
list_files = [
...
def parse_file():
    ...
    for file in list_files:
        ...
        with open(path_acc_data_json + file, "r") as file_acc, open (path_acc_data_json_combined + file, "r") as file_comb:
            ...
            analisi = mean_step_comb[cast_away:]
            ...
            for x in range(13, 3, -1):
                where_max_loc = _find_first_massimo(mean_step_comb[cast_away:], x)
