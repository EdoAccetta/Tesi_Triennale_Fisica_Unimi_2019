...
def output_all():
    ...
    with open(path_results + "risultati_all.csv", "w") as file_results:
        ...
        for file in list_files_grandezze:
            with open(path_position + file, "r") as file_posizioni, open(path_speed + file, "r") as file_speed, open(path_grandezze_basics + file, "r") as file_basics, open(path_grandezze_x + file, "r") as file_grandezze_x, open(path_grandezze_firstmax + file, "r") as file_firstmax, open(path_grandezze_second_min + file, "r") as file_second_min, open(path_grandezze_secondmax + file, "r") as file_secondmax:
