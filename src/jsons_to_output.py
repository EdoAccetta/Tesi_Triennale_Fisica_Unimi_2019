...
def output_all():
    ...
    with open(path_results + "risultati_all.csv", "w") as file_results:
        ...
        for file in list_files_grandezze:
            with open(path_position + file, "r") as file_posizioni, open(path_speed + file, "r") as file_speed, open(path_grandezze_x + file, "r") as file_grandezze_x:
                ...
                file_results.write("{}\nLunghezza Passo;{}\n T. Contatto;{}\n T. Volo;{}\n T. Totale;{}\n Ritmo;{}\n Velocita;{}\n\n".format(
                    file,to_virgul(json_positions["posizioni_minimi_delta_media"]),to_virgul(json_great_x["tempo_contatto"]),to_virgul(json_great_x["tempo_volo"]),to_virgul(json_great_x["tempo_totale"]),to_virgul(json_great_x["ritmo"]),to_virgul(json_speed["velocita_z_media"])))
