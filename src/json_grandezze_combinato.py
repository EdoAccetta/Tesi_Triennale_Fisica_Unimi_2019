...
path_acc_data_json_grandezze = path_acc_data + "/json_grandezze_combinato/"
list_files = [
    ...
    for file in list_files:
        ...
        with open(path_acc_data_json + file, "r") as file_acc:
            ...
            for x in range(0, len(minimi_array_index) - 2):
                ...
                array_in_campione = gfcs[minimi_array_index[x]:minimi_array_index[x+1]]
                ...
                # print("len(gfcs): {}".format(len(gfcs)))
